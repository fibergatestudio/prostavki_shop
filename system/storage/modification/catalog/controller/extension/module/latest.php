...
$data['module'] = $setting;
		...
		$data['products'] = array();
			...
			$data['bigshop_latest_slider_product_style'] = $this->config->get('bigshop_latest_slider_product_style');
			$data['bigshop_percentage_discount_badge'] = $this->config->get('bigshop_percentage_discount_badge');
			$data['bigshop_latest_slider_product_per_row'] = $this->config->get('bigshop_latest_slider_product_per_row');
