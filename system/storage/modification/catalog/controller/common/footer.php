...
if (!isset($this->request->get['route']) || $this->request->get['route'] == 'common/home'){
		...
		$data['bigshop_custom_payment_image'] = $this->config->get('bigshop_custom_payment_image');
		$data['bigshop_custom_payment_image_url'] = $this->config->get('bigshop_custom_payment_image_url');
