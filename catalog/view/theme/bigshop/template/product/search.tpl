...
<?php if($bigshop_search_product_per_row == 'pr3') { ?>
...
<?php } elseif ($bigshop_search_product_per_row == 'pr4') {?>
<script type="text/javascript">
$(document).ready(function(){
$(document).on('click', '#grid-view', function(e){
...
<?php } elseif ($bigshop_search_product_per_row == 'pr5') {?>
<script type="text/javascript">
$(document).ready(function(){
$(document).on('click', '#grid-view', function(e){
...
<?php } elseif ($bigshop_search_product_per_row == 'pr6') {?>
<script type="text/javascript">
$(document).ready(function(){
$(document).on('click', '#grid-view', function(e){
