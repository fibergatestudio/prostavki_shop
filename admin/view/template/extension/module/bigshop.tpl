                  ...
                  <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab4-language-<?php echo $language['language_id']; ?>">
                      ...
                      <div class="form-group">
                        <label class="col-sm-2 control-label" ><?php echo $entry_custom_column; ?></label>
                        <div class="col-sm-10">
                         <textarea id="input-description4<?php echo $language['language_id']; ?>" name="bigshop_custom_block2_content[<?php echo $language['language_id']; ?>][description]" class="form-control summernote"><?php echo isset($bigshop_custom_block2_content[$language['language_id']]['description']) ? $bigshop_custom_block2_content[$language['language_id']]['description'] : ''; ?></textarea>
                        </div>
                      </div>
                    </div>
                    <?php } ?>
                  ...
                  <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab5-language-<?php echo $language['language_id']; ?>">
                      ...
                      <div class="form-group">
                        <label class="col-sm-2 control-label" ><?php echo $entry_custom_column; ?></label>
                        <div class="col-sm-10">
                        <textarea id="input-description5<?php echo $language['language_id']; ?>" name="bigshop_custom_block3_content[<?php echo $language['language_id']; ?>][description]" class="form-control summernote"><?php echo isset($bigshop_custom_block3_content[$language['language_id']]['description']) ? $bigshop_custom_block3_content[$language['language_id']]['description'] : ''; ?></textarea>
                        </div>
                      </div>
                    </div>
                    <?php } ?>
